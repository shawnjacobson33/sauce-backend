...
class Logger:
    ...
    @staticmethod
    def pipeline_logger(pipeline: str, message: str):
        def decorator(pipeline_func):
            ...
            async def wrapped(self, *args, **kwargs):
                ...
                end_time = time.time()
                print(f'[{pipeline}]: Finished {message}...')

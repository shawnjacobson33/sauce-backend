...
from app.services.betting_lines.logging import pipeline_logger
...
async def _get_last_batch_details(reset: bool = False) -> datetime:
    if reset:
...
@pipeline_logger(message='Running Betting Lines Pipeline')

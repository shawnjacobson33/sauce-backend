...
class ThriveFantasySpider:
    def __init__(self, batch_id: uuid.UUID, req_mngr: RequestManager, data_normalizer: DataNormalizer):
    ...
    async def start(self):
        ...
        await self.req_mngr.post(url, self._parse_lines, headers=headers, cookies=cookies, json=json_data)

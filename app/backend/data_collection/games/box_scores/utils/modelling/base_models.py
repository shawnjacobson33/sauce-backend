from app.backend.data_collection.utils.shared_data import BoxScores
...
class BoxScoreRetriever(Retriever):
    def __init__(self, source: GameSource):
        super().__init__(source)

    def update_box_scores(self, game_id: str, subject_id: str, box_score: dict) -> None:
        # add the game to the shared data structure
        BoxScores.update_box_scores(self.source.league, game_id, subject_id, box_score)
